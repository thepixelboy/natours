...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGhlcGl4ZWxib3kiLCJhIjoiY2tocnk0dWVoMHo1ajJ0cnNwc2g5azVxdiJ9.Z2py9UEhaCAQ8xytNYjxwQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/thepixelboy/ckhryg0js2ao419t7jn8ob79d',
    scrollZoom: false // center: [-118.1476948, 34.148757],
    // zoom: 8,
    // interactive: false,
...
var stripe = Stripe('pk_test_51HstSOG51mU2XFIfZFDiXdYe2ybIzzcWBYgwgvCgxpONTK50A4MqBE5iaT1Zdvn5nmt2Vzj4TRNzyMNzuVWi7Ohy00VmEeB50B');
